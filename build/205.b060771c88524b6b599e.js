        ...
        28571: (e, t, a) => {
            ...
            const p = o()((e) => {
                ...
                b = a || t,
                    ...
                    L = (0, i.Z)({ path: b, validate: _, condition: Z }), { value: k, showError: V, setValue: H, errorMessage: M } = L,
                ...
                v = () => {
                    ...
                    return a ?
                        ...
                        l.createElement(
                            ...
                            Array.isArray(b) &&
                            b.map((e, t) => l.createElement(e, { key: t })), !$.auth.disableLocalStrategy &&
                            l.createElement(
                                u.Z, {
                                    disableSuccessStatus: !0,
                                    waitForAutocomplete: !0,
                                    onSuccess: (t) => {
                                        t.token && (v(t.token), e.push(V));
                                    },
                                    method: "post",
                                    action: `${k}${H}/${y}/login`,
                                },
